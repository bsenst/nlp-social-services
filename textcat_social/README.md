...
# 🪐 Weasel Project: Social Service Textcat (Text Classification)

A minimal social service textcat project for spaCy v3. The code comes from the [tutorials/textcat_docs_issues](https://github.com/explosion/projects/tree/v3/tutorials/textcat_docs_issues) project.
